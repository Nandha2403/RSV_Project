            ...
            <Box className="Solutions_content_container">
              ...
              <Box className="text_container">
                <Text>
                  ...
                  the DTF, and the transfer of images starts. As the images are
                  transferred, they are blinded and anonymized based on study
                  configurations. RadGate also checks for duplicates, "bad"
                  DICOM files, etc., runs edit checks to check for data issues
                  (e.g., wrong modality, incorrect acquisition parameters if
                  configured, etc.), and can automatically create Data
                  Clarification Forms (DCFs) or Protocol Deviations (PDs) that
                  have to be addressed by the site/corelab staff. Once all the
                  images are uploaded, a copy of the DTF is sent to the site for
                  their records, and the uploaded content is added to the
            ...
            <Box className="Solutions_content_container">
              ...
              <Box className="text_container">
                <Text>
                  ...
                  review, assessed using a browser. Alternatively, the tool may
                  provide the opportunity for the submission to contain
                  hyperlinks to images in the repository. Reviewers will have
            ...
            <Box className="Solutions_content_container">
              ...
              <Box className="text_container">
                <Text>
                  ...
                  patient. Images are rendered in the browser and made available
                  to the user along with additional non-image data, such as
            ...
            <Box className="Solutions_content_container">
              ...
              <Box className="text_container">
                <Text>
                  ...
                  automatically upload them to CLIB. The app supports
                  interactive help to assist subjects during image acquisition.
                  Additionally, the app facilitates image QC and analysis on the
                  phone before upload, improving the quality of acquired images.
                  The App also supports a patient-centric eCRF (e.g., QOL form,
                  etc.) to capture responses directly from patients. RSV is also
            ...
            <Box className="Solutions_content_container">
              ...
              <Box className="text_container">
                <Text>
                  ...
                  event to be assessed. Uploaded content is QCed, including
                  features for redaction, translation, merging, splitting, and
                  concatenating of documents as needed. Custom workflows can be
                  set up to process any of the uploaded data. Once dossiers are
                  created, experts can review the dossier and respond to eCRF
                  questions. Assessments can be compared, and further reads can
